/*
Problem : Find nearest smaller integer

Approach : Traverse the array using a monotonic increasing stack, or each element, 
            pop all elements greater than or equal to it

Time Complexity: O(n)
Space Complexity: O(n)

Submission link : https://cses.fi/problemset/result/15776962/
*/
#include <bits/stdc++.h>
#include <bits/stdc++.h>
