//https://cses.fi/problemset/result/15782252/
/*
Approach using priority q
First we will store the original vector as a pair of arr/dep and index.
We will sort the vector so that the person who comes first can be alloted room earlier
We will allot rooms using pq(min heap)
Pq will help us in storing th room no. which will be empty th eearliest
If the person who visits arrives after the room is empty then we can give them this room else
we allot them a new room.
*/
#include <bits/stdc++.h>
using namespace std;
