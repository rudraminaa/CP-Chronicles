...
Approach : If we want f(x) to be minimum then we need to make x the median of open bars.
            In short, we need to find the number of maximum points after closing at most k bars such that f(x) is min;
            It can be done by cloding bars in middle,

Time Complexity : O(nlogn) for sorting
Space Complexity : O(1)

Submission link : https://codeforces.com/contest/2098/submission/356166228
*/
#include <bits/stdc++.h>
#include <bits/stdc++.h>
